...
Route::get('/admin/horarios/{id}/confirm-delete', [App\Http\Controllers\HorarioController::class, 'confirmDelete'])->name('admin.docthorariosores.confirmDelete')->middleware('auth','can:admin.docthorariosores.confirmDelete');
