...
<head>
  ...
  <!-- ** Basic Page Needs ** -->
  <meta charset="utf-8">
  <title>Medic | Sistema de Reserva de Citas</title>
  ...
  <!-- bootstrap -->
  <link rel="stylesheet" href="{{ asset('medic/plugins/bootstrap/bootstrap.min.css') }}">
  <!-- Slick Carousel -->
  <link rel="stylesheet" href="{{ asset('medic/plugins/slick/slick.css') }}">
  <link rel="stylesheet" href="{{ asset('medic/plugins/slick/slick-theme.css') }}">
  <!-- FancyBox -->
  <link rel="stylesheet" href="{{ asset('medic/plugins/fancybox/jquery.fancybox.min.css') }}">
  <!-- fontawesome -->
  <link rel="stylesheet" href="{{ asset('medic/plugins/fontawesome/css/all.min.css') }}">
  <!-- animate.css -->
  <link rel="stylesheet" href="{{ asset('medic/plugins/animation/animate.min.css') }}">
  <!-- jquery-ui -->
  <link rel="stylesheet" href="{{ asset('medic/plugins/jquery-ui/jquery-ui.css') }}">
  <!-- timePicker -->
  <link rel="stylesheet" href="{{ asset('medic/plugins/timePicker/timePicker.css') }}">
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-xl-4 col-lg-3">
        <div class="logo">
  <a href="{{ url('/') }}">
    <img loading="lazy" class="img-fluid" src="{{ asset('medic/images/logo.png') }}" alt="logo">
  </a>
</div>
      </div>
      <div class="col-xl-8 col-lg-9">
        <div class="right-side">
          ...
          <div class="link-btn text-center text-lg-right">
            <a href="{{url('login')}}" class="btn-style-one">Ingresar</a>
          </div>
        </div>
      </div>
    </div>
