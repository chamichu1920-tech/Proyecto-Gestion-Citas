...
use Spatie\Permission\Models\Role; // <--- AGREGA ESTA LÍNEA AQUÍ
use Spatie\Permission\Models\Permission; // <--- AGREGADO
...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name'=>'admin.docthorariosores.confirmDelete'])->syncRoles([$admin,$secretaria]);
